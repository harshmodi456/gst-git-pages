            ...
            return (
                <div className='header d-flex px-2 justify-content-between w-100'>
                    <div className='d-flex justify-content-start align-items-center'>
                        <Avatar className='mr-2' size='52' round name={(review?.gstId?.gstData?.tradeNam).slice(0, 1)} src={review?.userId?.profileImg} />
                        <div>
                            <p className='user-name m-0 break-line-1'>{review?.gstId?.gstData?.tradeNam}</p>
                            <p className='time-lable text-muted m-0'><ReactTimeAgo timeStyle="round-minute" date={review?.createdAt} locale="en-US" /></p>
                        </div>
                    </div>
                    <div>
                        <div className='d-flex justify-content-end'>
                            <p className="m-0 mr-2 mt-1">{Math.round(review?.rating || 0).toFixed(1)}</p>
                            <Rating
        ...
        <div className='col-lg-6 col-md-12 px-md-3 my-3 px-3'>
            <div className='review-card-container h-100 p-3'>
                ...
                <div className='body px-2 py-3'>
                    <p className='m-0 min-height-wrap'>
                        {
                            showFullReview ? (
                                review?.reviewText
                            ) : (
                        ...
                        }
                        {
                            ...
                            <>
                                {
                                    showFullReview ? (
                                        <button className='btn-view ml-3' onClick={() => setShowFullReview(!showFullReview)}>hide</button>
                                    ) : (
                                        <button className='btn-view ml-3' onClick={() => setShowFullReview(!showFullReview)}>View more</button>
                                    )
                                }
                            </>
                        }
                ...
                <div className="modal-dialog modal-dialog-centered  modal-lg" role="document">
                    <div className="modal-content modal-lg">
                        <div className="modal-header p-10">
                            <h5 className="modal-title" id="exampleModalLongTitle">{review?.gstId?.gstData?.tradeNam}</h5>
                        </div>
